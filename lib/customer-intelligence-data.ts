...
const residentialNames = [
  'Artisan Butcher Shop', 'Local Meat Market', 'Family Butchery', 'Premium Meats',
  'Fresh Cut Deli', 'Neighborhood Butcher', 'Heritage Meats', 'Quality Cuts',
  'Farm Fresh Meats', 'Gourmet Butcher'
]

const commercialNames = [
  'Industrial Meat Processing', 'Commercial Sausage Works', 'Meat Packing Co',
  'Food Processing Center', 'Protein Solutions', 'Meat Production Hub', 'Processing Plant',
  'Commercial Kitchen Equipment'
]

const utilityNames = [
  'National Meat Processors', 'Regional Meat Co-op', 'Wholesale Meat Distribution',
  'Large-Scale Processing Facility', 'Industrial Food Group', 'Export Meat Processing',
  'Integrated Meat Solutions', 'Bulk Processing Center'
]
